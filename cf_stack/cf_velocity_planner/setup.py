...
package_name = 'cf_velocity_planner'
...
data_flies.append(('share/' + package_name + '/launch', ['launch/cf_velocity_planner.launch.py']))
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'velocity_planner = cf_velocity_planner.velocity_planner:main'
        ],
    },
)
