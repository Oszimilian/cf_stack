...
data_flies.append(('share/' + package_name + '/launch', ['launch/cf_pathplanning.launch.py']))
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'pathplanning = cf_pathplanning.pathplanning:main'
        ],
    },
)
