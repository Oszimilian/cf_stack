...
package_name = 'cf_trajectory_opt'
...
data_flies.append(('share/' + package_name + '/launch', ['launch/cf_trajectory_opt.launch.py']))
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'trajectory_opt = cf_trajectory_opt.trajectory_opt:main'
        ],
    },
)
